...
| Très complexe (nouveau système, agents, DB) | `architect` agent + skill `superpowers:writing-plans` |
...
**ALWAYS** invoquer `architect` agent + skill `superpowers:writing-plans` pour un nouveau système ou archi complexe.
