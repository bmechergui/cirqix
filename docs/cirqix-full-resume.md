...
- Routage auto : **plan de masse coulé et rempli D'ABORD** (les deux faces extérieures), puis les signaux (GND confié au plan), puis fanout, vias et couture des îlots répétée. Escalade 2 → 4 → 6 … avec 3 tirages par palier (Freerouting est stochastique : 65/77/91 % sur le même board) ; on garde toujours le meilleur, et on abandonne les tirages d'un palier sous 80 % — il ne peut plus rattraper 100 %.
