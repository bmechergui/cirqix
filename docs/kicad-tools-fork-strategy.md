...
- **Tradeoff :** le checkout doit initialiser les deux sous-modules directs Cirqix
  (`git submodule update --init`, sans les sous-modules optionnels imbriqués de Circuit-Synth)
